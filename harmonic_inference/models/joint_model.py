...
class HarmonicInferenceModel:
    ...
    def get_key_change_states(self, states: List[State], hidden_only: bool = False) -> List[State]:
        ...
        # Generate KSM loader
        ksm_dataset = ds.KeySequenceDataset([], self.key_sequence_model.get_dataset_kwargs())
    ...
    def run_csm_batched(self, states: List[State]):
        ...
        # Generate CSM loader
        csm_dataset = ds.ChordSequenceDataset([], self.chord_sequence_model.get_dataset_kwargs())
